	...
	g.prototype = d.extend({}, f, {
		...
		maskAnimationBack: function(a) {
			a.touchNum >= 3 && !a.touchFinish && (a.touchFinish = !0, a.touchFinish && e.enableFlipPage(), a.maskAnimation(a, 4, 5, 20, 80, function() {
			    jQuery("img.img-group-1").trigger("sporty_1");
		...
		var a = function(a) {
			...
			this.$target = a.addClass("m-cascadingTeletext"), this.$_currentItem = this.$target.find("li").first().addClass("z-current"), d(window).on("resize", function() {
			 ...
			 this.$target.on(d.isPC ? "click" : "swipeLeft swipeRight", function(a) {
				if (b.$_currentItem.find('img').hasClass('img-group-1')) jQuery("img.img-group-2").trigger("sporty_2");
				else if (b.$_currentItem.find('img').hasClass('img-group-2')) jQuery("img.img-group-3").trigger("sporty_3");
				else if (b.$_currentItem.find('img').hasClass('img-group-3')) jQuery("img.img-group-4").trigger("sporty_4");
				else if (b.$_currentItem.find('img').hasClass('img-group-4')) jQuery("img.img-group-5").trigger("sporty_5");
				else if (b.$_currentItem.find('img').hasClass('img-group-5')) jQuery("img.img-group-6").trigger("sporty_6");
				else if (b.$_currentItem.find('img').hasClass('img-group-6')) jQuery("img.img-group-7").trigger("sporty_7");
	...
	var d = a("lib/zepto/zepto"),
		...
		f = function(a) {
			...
			this._$globalAudio.append(this._$tip), this._$globalAudio.coffee({
				steams: ['<img src="/Public/Mob/1/tp1/template/22/source/styles/img/musicalNotes.png"/>', '<img src="/Public/Mob/1/tp1/template/22/source/styles/img/musicalNotes.png"/>', '<img src="/Public/Mob/1/tp1/template/22/source/styles/img/musicalNotes.png"/>', '<img src="/Public/Mob/1/tp1/template/22/source/styles/img/musicalNotes.png"/>', '<img src="/Public/Mob/1/tp1/template/22/source/styles/img/musicalNotes.png"/>', '<img src="/Public/Mob/1/tp1/template/22/source/styles/img/musicalNotes.png"/>'],
				steamHeight: 100,
				steamWidth: 50
